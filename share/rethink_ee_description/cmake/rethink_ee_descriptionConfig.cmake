...
if("FALSE" STREQUAL "TRUE")
  set(rethink_ee_description_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-rethink-ee-description-1.2.0)
  set(rethink_ee_description_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-rethink-ee-description-1.2.0/obj-x86_64-linux-gnu/devel)
  ...
  set(rethink_ee_description_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rethink_ee_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
