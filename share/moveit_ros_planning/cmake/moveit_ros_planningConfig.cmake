...
if("FALSE" STREQUAL "TRUE")
  set(moveit_ros_planning_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-moveit-ros-planning-0.7.13)
  set(moveit_ros_planning_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-moveit-ros-planning-0.7.13/obj-x86_64-linux-gnu/devel)
  ...
  set(moveit_ros_planning_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_ros_planning' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>, Michael Görner <me@v4hn.de>, MoveIt! Release Team <moveit_releasers@googlegroups.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_ros_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>, Michael Görner <me@v4hn.de>, MoveIt! Release Team <moveit_releasers@googlegroups.com>' to fix it.")
    endif()
