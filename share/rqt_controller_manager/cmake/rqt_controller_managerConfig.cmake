...
if("FALSE" STREQUAL "TRUE")
  set(rqt_controller_manager_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-rqt-controller-manager-0.9.6)
  set(rqt_controller_manager_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-rqt-controller-manager-0.9.6/obj-x86_64-linux-gnu/devel)
  ...
  set(rqt_controller_manager_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
    endif()
