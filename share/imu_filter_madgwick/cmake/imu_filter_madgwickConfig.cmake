...
if("FALSE" STREQUAL "TRUE")
  set(imu_filter_madgwick_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-imu-filter-madgwick-1.0.15)
  set(imu_filter_madgwick_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-imu-filter-madgwick-1.0.15/obj-x86_64-linux-gnu/devel)
  ...
  set(imu_filter_madgwick_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Martin Günther <martin.guenther1980@gmail.com>, Ivan Dryanovski <ivan.dryanovski@gmail.com>' to fix it.")
    endif()
