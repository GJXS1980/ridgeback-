...
if("FALSE" STREQUAL "TRUE")
  set(base_local_planner_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-base-local-planner-1.12.15)
  set(base_local_planner_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-base-local-planner-1.12.15/obj-x86_64-linux-gnu/devel)
  ...
  set(base_local_planner_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'base_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mfergs7@gmail.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
    endif()
