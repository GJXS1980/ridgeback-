...
if("FALSE" STREQUAL "TRUE")
  set(bhand_controller_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-bhand-controller-0.1.1)
  set(bhand_controller_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-bhand-controller-0.1.1/obj-x86_64-linux-gnu/devel)
  ...
  set(bhand_controller_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'bhand_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Román Navarro <rnavarro@robotnik.es>, Jorge Ariño <jarino@robotnik.es>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'bhand_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Román Navarro <rnavarro@robotnik.es>, Jorge Ariño <jarino@robotnik.es>' to fix it.")
    endif()
...
set(bhand_controller_EXPORTED_TARGETS "bhand_controller_generate_messages_cpp;bhand_controller_generate_messages_lisp;bhand_controller_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${bhand_controller_dep}_FOUND)
      find_package(${bhand_controller_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${bhand_controller_dep} REQUIRED ${depend_list})
  endif()
