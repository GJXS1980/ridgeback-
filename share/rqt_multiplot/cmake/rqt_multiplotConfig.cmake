...
if("FALSE" STREQUAL "TRUE")
  set(rqt_multiplot_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-rqt-multiplot-0.0.7)
  set(rqt_multiplot_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-rqt-multiplot-0.0.7/obj-x86_64-linux-gnu/devel)
  ...
  set(rqt_multiplot_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rqt_multiplot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ralf Kaestner <ralf.kaestner@gmail.com>, Samuel Bachmann <samuel.bachmann@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rqt_multiplot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Ralf Kaestner <ralf.kaestner@gmail.com>, Samuel Bachmann <samuel.bachmann@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rqt_multiplot_dep}_FOUND)
      find_package(${rqt_multiplot_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rqt_multiplot_dep} REQUIRED ${depend_list})
  endif()
