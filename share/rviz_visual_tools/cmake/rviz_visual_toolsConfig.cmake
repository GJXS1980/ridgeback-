...
if("FALSE" STREQUAL "TRUE")
  set(rviz_visual_tools_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-rviz-visual-tools-2.2.1)
  set(rviz_visual_tools_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-rviz-visual-tools-2.2.1/obj-x86_64-linux-gnu/devel)
  ...
  set(rviz_visual_tools_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rviz_visual_tools' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dave Coleman <davetcoleman@gmail.com>, Andy McEvoy <mcevoy.andy@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rviz_visual_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dave Coleman <davetcoleman@gmail.com>, Andy McEvoy <mcevoy.andy@gmail.com>' to fix it.")
    endif()
    _list_append_unique(rviz_visual_tools_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rviz_visual_tools")
...
set(depends "eigen_conversions;geometry_msgs;visualization_msgs;graph_msgs;std_msgs;tf_conversions;trajectory_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rviz_visual_tools_dep}_FOUND)
      find_package(${rviz_visual_tools_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rviz_visual_tools_dep} REQUIRED ${depend_list})
  endif()
