...
if("FALSE" STREQUAL "TRUE")
  set(moveit_resources_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-moveit-resources-0.6.2)
  set(moveit_resources_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-moveit-resources-0.6.2/obj-x86_64-linux-gnu/devel)
  ...
  set(moveit_resources_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_resources' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>' to fix it.")
    endif()
