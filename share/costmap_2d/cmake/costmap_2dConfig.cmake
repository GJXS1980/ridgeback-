...
if("FALSE" STREQUAL "TRUE")
  set(costmap_2d_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-costmap-2d-1.12.15)
  set(costmap_2d_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-costmap-2d-1.12.15/obj-x86_64-linux-gnu/devel)
  ...
  set(costmap_2d_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-5.8 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mfergs7@gmail.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
    endif()
