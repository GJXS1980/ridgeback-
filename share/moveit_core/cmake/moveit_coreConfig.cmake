...
if("FALSE" STREQUAL "TRUE")
  set(moveit_core_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-moveit-core-0.7.13)
  set(moveit_core_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-moveit-core-0.7.13/obj-x86_64-linux-gnu/devel)
  ...
  set(moveit_core_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Michael Görner <me@v4hn.de>, Michael Ferguson <mferguson@fetchrobotics.com>, MoveIt! Release Team <moveit_releasers@googlegroups.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Michael Görner <me@v4hn.de>, Michael Ferguson <mferguson@fetchrobotics.com>, MoveIt! Release Team <moveit_releasers@googlegroups.com>' to fix it.")
    endif()
    _list_append_unique(moveit_core_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "moveit_exceptions;moveit_background_processing;moveit_kinematics_base;moveit_robot_model;moveit_transforms;moveit_robot_state;moveit_robot_trajectory;moveit_planning_interface;moveit_collision_detection;moveit_collision_detection_fcl;moveit_kinematic_constraints;moveit_planning_scene;moveit_constraint_samplers;moveit_planning_request_adapter;moveit_profiler;moveit_trajectory_processing;moveit_distance_field;moveit_kinematics_metrics;moveit_dynamics_solver;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_iostreams.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/opt/ros/indigo/lib/liboctomap.so;/opt/ros/indigo/lib/liboctomath.so;/usr/lib/x86_64-linux-gnu/liburdfdom_sensor.so;/usr/lib/x86_64-linux-gnu/liburdfdom_model_state.so;/usr/lib/x86_64-linux-gnu/liburdfdom_model.so;/usr/lib/x86_64-linux-gnu/liburdfdom_world.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so")
