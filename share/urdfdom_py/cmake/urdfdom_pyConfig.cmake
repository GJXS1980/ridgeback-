...
if("FALSE" STREQUAL "TRUE")
  set(urdfdom_py_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-urdfdom-py-0.3.3)
  set(urdfdom_py_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-urdfdom-py-0.3.3/obj-x86_64-linux-gnu/devel)
  ...
  set(urdfdom_py_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'urdfdom_py' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'urdfdom_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${urdfdom_py_dep}_FOUND)
      find_package(${urdfdom_py_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${urdfdom_py_dep} REQUIRED ${depend_list})
  endif()
