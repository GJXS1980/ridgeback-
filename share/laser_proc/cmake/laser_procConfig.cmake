...
if("FALSE" STREQUAL "TRUE")
  set(laser_proc_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-laser-proc-0.1.4)
  set(laser_proc_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-laser-proc-0.1.4/obj-x86_64-linux-gnu/devel)
  ...
  set(laser_proc_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@willowgarage.com>' to fix it.")
    endif()
