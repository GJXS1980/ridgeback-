...
if("FALSE" STREQUAL "TRUE")
  set(rosparam_shortcuts_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-rosparam-shortcuts-0.1.1)
  set(rosparam_shortcuts_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-rosparam-shortcuts-0.1.1/obj-x86_64-linux-gnu/devel)
  ...
  set(rosparam_shortcuts_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosparam_shortcuts' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosparam_shortcuts_dep}_FOUND)
      find_package(${rosparam_shortcuts_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosparam_shortcuts_dep} REQUIRED ${depend_list})
  endif()
