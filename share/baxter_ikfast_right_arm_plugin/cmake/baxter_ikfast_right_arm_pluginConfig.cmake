...
if("FALSE" STREQUAL "TRUE")
  set(baxter_ikfast_right_arm_plugin_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-baxter-ikfast-right-arm-plugin-1.0.7)
  set(baxter_ikfast_right_arm_plugin_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-baxter-ikfast-right-arm-plugin-1.0.7/obj-x86_64-linux-gnu/devel)
  ...
  set(baxter_ikfast_right_arm_plugin_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_ikfast_right_arm_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
