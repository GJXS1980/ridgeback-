...
if("FALSE" STREQUAL "TRUE")
  set(hector_gazebo_plugins_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-hector-gazebo-plugins-0.3.8)
  set(hector_gazebo_plugins_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-hector-gazebo-plugins-0.3.8/obj-x86_64-linux-gnu/devel)
  ...
  set(hector_gazebo_plugins_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
