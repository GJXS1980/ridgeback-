...
if("TRUE" STREQUAL "TRUE")
  set(myworkcell_core_SOURCE_PREFIX /home/administrator/ur_ws/src/myworkcell_core)
  set(myworkcell_core_DEVEL_PREFIX /home/administrator/ur_ws/devel)
  ...
  set(myworkcell_core_INSTALL_PREFIX /home/administrator/ur_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ros-industrial <ros-industrial@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/administrator/ur_ws/src/myworkcell_core/${idir}'.  Ask the maintainer 'ros-industrial <ros-industrial@todo.todo>' to fix it.")
    endif()
...
set(myworkcell_core_EXPORTED_TARGETS "myworkcell_core_generate_messages_cpp;myworkcell_core_generate_messages_lisp;myworkcell_core_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${myworkcell_core_dep}_FOUND)
      find_package(${myworkcell_core_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${myworkcell_core_dep} REQUIRED ${depend_list})
  endif()
